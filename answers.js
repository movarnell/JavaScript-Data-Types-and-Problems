// Below are the best practices for each exercise. You can use these as a reference when you're stuck. There are many ways to solve each problem, so don't worry if your solution is different.
...
let emptyBox = null;
console.log(typeof emptyBox); // object
...
console.log(joinedSentence); // "Learning JavaScript is fun"
...
console.log(age < 18 ? "Minor" : "Adult"); // Adult

// 24. Finding Array Elements: Check if 'colors' array contains "green". Log "Found" or "Not found".
console.log(colors.includes("green") ? "Found" : "Not found"); // Found
...
// Output depends on the value of 'grade'
